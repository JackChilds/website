...
<div className="w-screen h-screen absolute top-0 left-0 -z-10">
  ...
  <div className="absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] rounded-3xl bg-base-300 shadow-[0_0_5px_4px_rgba(10,10,10,0.3)] flex justify-center items-center text-center color-white p-8 cursor-pointer" onClick={() => {jump('#about')}}>
